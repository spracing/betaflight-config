...
#define BOARD_NAME              SPRACINGH7NEO
#define MANUFACTURER_ID         SPRO

#define TARGET_BOARD_IDENTIFIER "SP7O"
#define USBD_PRODUCT_STRING     "SPRacingH7NEO"
...
#define ADC_RSSI_PIN         PC3 // current meter 2 on 4in1ESC2 connector (J1:6)
#define ADC_CURR_PIN         PC1 // current meter 1 on 4in1ESC1 connector (J5:6)
...
#define RX_SPI_EXPRESSLRS_BUSY_PIN PE3
